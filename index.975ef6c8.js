...
var _auto = require("chart.js/auto"); // Import Chart.js
var _autoDefault = parcelHelpers.interopDefault(_auto);
var _stylesCss = require("./styles.css"); // Import a CSS file
...
const project_progress = new (0, _autoDefault.default)(document.querySelector("#project-progress canvas").getContext("2d"), {
    type: "doughnut",
    data: projectProgress_data
});
const steel = new (0, _autoDefault.default)(document.querySelector("#steel canvas").getContext("2d"), {
    type: "pie",
    data: data
});
const cement = new (0, _autoDefault.default)(document.querySelector("#cement canvas").getContext("2d"), {
    type: "pie",
    data: data
});
const cost_flow = new (0, _autoDefault.default)(document.querySelector("#cost-flow canvas").getContext("2d"), {
    type: "bar",
    data: data
});
const time_table = new (0, _autoDefault.default)(document.querySelector("#time-table canvas").getContext("2d"), {
    type: "bar",
    data: data
});
function test() {
    try {
        ...
        Excel.Visible = true;
        Excel.Workbooks.Open("C:\\path_to_your_file\\Book1.xlsx"); // Use the full path to the Excel file
    } catch (error) {
        console.error("Error: " + error.message);
    }
}
let excelBtn = document.querySelector("#excelBtn"); // Fixed typo here
excelBtn.addEventListener("click", test);
console.log(excelBtn);

},{"chart.js/auto":"d8NN9","./styles.css":"lW6qc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"lW6qc":[function() {},{}]},["9mu7C","8lqZg"], "8lqZg", "parcelRequire94c2")
